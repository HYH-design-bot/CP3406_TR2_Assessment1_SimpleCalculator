# CP3406 Simple Calculator App Assessment 1

Simple Calculator app using a basic Android app template for **Assessment 1: Utility App** in CP3406/CP5603 as a foundation  
...
### UtilityScreen()
- Displays a Simple Calculator like UI
- Punch the buttons to create a math formula, press "=" to get the result, press "C" to clear the text
